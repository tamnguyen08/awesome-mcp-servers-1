...
- <img src="https://cdn.simpleicons.org/html5/E34F26" height="14"/> [Fast HTML MCP](https://github.com/Aimino-Tech/fast-html-mcp) - Five-tier MCP server for lightning-fast HTML generation from AI agents. 15 tools, 22 components, 25 templates for assembly, patch, read, raw, and consistency tiers.
